...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white text-red-600 p-6">
      {/* Animated Title */}
      <motion.h1
        className="text-4xl md:text-6xl font-extrabold mb-6 drop-shadow-lg text-center"
      ...
      <div className="relative mb-12 w-full max-w-3xl text-center">
        <div className="relative bg-white px-4 py-2 border-l-4 border-red-600 shadow-lg">
